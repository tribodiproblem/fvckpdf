...
[![Test](https://github.com/tribodiproblem/fvckpdf/workflows/Test/badge.svg)](https://github.com/tribodiproblem/fvckpdf/actions)
...
[![GoDoc](https://godoc.org/github.com/tribodiproblem/fvckpdf?status.svg)](https://pkg.go.dev/github.com/tribodiproblem/fvckpdf)
[![Go Report Card](https://goreportcard.com/badge/github.com/tribodiproblem/fvckpdf)](https://goreportcard.com/report/github.com/tribodiproblem/fvckpdf)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/tribodiproblem/fvckpdf/releases)
...
* For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/tribodiproblem/fvckpdf/pkg/api).

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/tribodiproblem/fvckpdf)
* [pdfcpu API](https://pkg.go.dev/github.com/tribodiproblem/fvckpdf/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/tribodiproblem/fvckpdf/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/tribodiproblem/fvckpdf/releases).
...
```
go get github.com/tribodiproblem/fvckpdf/cmd/...
cd $GOPATH/src/github.com/tribodiproblem/fvckpdf/cmd/pdfcpu
go install
pdfcpu version
```
...
```
git clone https://github.com/tribodiproblem/fvckpdf
